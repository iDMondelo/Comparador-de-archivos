...
- **Formatos de entrada**: PDF, .ai, JPG, PNG.
...
- **Simulación de sobreimpresión** en PDF/.ai: el archivo se reescribe en memoria (nunca en disco) traduciendo los objetos sobreimpresos (/OP, /op) al modo Multiplicar, de modo que el negro y las tintas sobreimpresas se ven fundidas con el fondo y no caladas en blanco. Se aplica siempre por igual a ambos archivos.
...
| `overprint.js` | Simulación de sobreimpresión: reescritura del PDF en memoria (vía pdf-lib) traduciendo /OP a Multiplicar, interruptor e indicador |
...
Incluidas en `lib/` y con licencia propia:

- [pdf.js](https://github.com/mozilla/pdf.js) — Mozilla (Apache 2.0)
- [Tesseract.js](https://github.com/naptha/tesseract.js) — naptha (Apache 2.0)
